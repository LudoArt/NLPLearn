...
TRAIN_DATA = "I:/NLPLearn/RNN/data/ptb.train"  # 训练数据路径
EVAL_DATA = "I:/NLPLearn/RNN/data/ptb.valid"  # 验证数据路径
TEST_DATA = "I:/NLPLearn/RNN/data/ptb.test"  # 测试数据路径
...
class PTBModel(object):
    def __init__(self, is_training, batch_size, num_steps):
        ...
        # 定义使用的LSTM结构为循环体结构且使用dropout的深层循环神经网络
        ...
        # 把输入队列展开成[batch, hidden_size*num_steps]的形状，然后再reshape成[batch*num_steps, hidden_size]的形状
...
def main():
    ...
    # 定义测试用的循环神经网络模型，与train_model共用参数，但没有dropout

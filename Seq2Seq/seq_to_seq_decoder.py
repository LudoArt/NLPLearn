...
CHECKPOINT_PATH = "H:/NLPLearn/Seq2Seq/data/seq2seq_ckpt-9000"  # checkpoint保存路径。9000表示是训练程序在第9000步保存的checkpoint
...
# 词汇表文件
SRC_VOCAB = "H:/NLPLearn/Seq2Seq/data/en.vocab"
TRG_VOCAB = "H:/NLPLearn/Seq2Seq/data/zh.vocab"
...
class NMTModel(object):
    ...
    def __init__(self):
        # 与训练时的__init__函数相同，通常在训练程序和解码程序中复用NMTModel类及其__init__函数，
        # 以确保解码时和训练时定义的变量是相同的
    ...
    def inference(self, src_input):
        ...
        with tf.variable_scope("decoder/rnn/multi_rnn_cell"):
            ...
            # 构建初始的循环状态。循环状态包含循环神经网络的隐藏状态，保存生成句子的TensorArray，
            # 以及记录解码步数的一个整数step
            init_loop_var = (enc_state, init_array, 0)

            # tf.while_loop的循环条件：
            # 循环知道解码器输出<eos>，或者达到最大步数位置

...
# 假设输入数据已经转换成了单词编号的格式
SRC_TRAIN_DATA = "H:/NLPLearn/Seq2Seq/data/train.en"  # 源语言输入文件
TRG_TRAIN_DATA = "H:/NLPLearn/Seq2Seq/data/train.zh"  # 目标语言输入文件
CHECKPOINT_PATH = "H:/NLPLearn/Seq2Seq/data/seq2seq_ckpt"  # checkpoint保存路径
...
class NMTModel(object):
    ...
    def forward(self, src_input, src_size, trg_input, trg_label, trg_size):
        ...
        # 它的维度是[batch_size, max_time, HIDDEN_SIZE]

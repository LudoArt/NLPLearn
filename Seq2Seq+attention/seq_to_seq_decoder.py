...
CHECKPOINT_PATH = "H:/NLPLearn/Seq2Seq+attention/data/seq2seq_ckpt-9000"  # checkpoint保存路径。9000表示是训练程序在第9000步保存的checkpoint
...
# 词汇表文件
SRC_VOCAB = "H:/NLPLearn/Seq2Seq+attention/data/en.vocab"
TRG_VOCAB = "H:/NLPLearn/Seq2Seq+attention/data/zh.vocab"
